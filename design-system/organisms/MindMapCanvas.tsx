...
export interface MindMapCanvasProps extends EntityDisplayProps {
  ...
  /** Event name to emit when zoom changes */
  zoomChangeEvent?: string;
  /** Event name to emit when pan changes */
  panChangeEvent?: string;
  /** Actions available */
...
export const MindMapCanvas = ({
  ...
  const handleWheel = useCallback(
    (e: React.WheelEvent) => {
      ...
      if (zoomChangeEvent) eventBus.emit(`UI:${zoomChangeEvent}`, { zoom: newZoom });
    },
    [enableZoom, zoom, minZoom, maxZoom, eventBus, zoomChangeEvent],
  );
  ...
  const handleMouseMove = useCallback(
    (e: React.MouseEvent) => {
      ...
      if (panChangeEvent) eventBus.emit(`UI:${panChangeEvent}`, newPan);
    },
    [isPanning, panStart, eventBus, panChangeEvent],
  );
