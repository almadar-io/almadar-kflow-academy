...
import orbEn from '../../../../stories/series-5-craft/meaning-in-numbers.orb';
import orbAr from '../../../../stories/series-5-craft/meaning-in-numbers.ar.orb';
import orbSl from '../../../../stories/series-5-craft/meaning-in-numbers.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/Meaning in Numbers',
