...
import orbEn from '../../../../stories/series-5-craft/the-safety-net.orb';
import orbAr from '../../../../stories/series-5-craft/the-safety-net.ar.orb';
import orbSl from '../../../../stories/series-5-craft/the-safety-net.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/The Safety Net',
