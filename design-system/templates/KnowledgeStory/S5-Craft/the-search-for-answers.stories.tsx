...
import orbEn from '../../../../stories/series-5-craft/the-search-for-answers.orb';
import orbAr from '../../../../stories/series-5-craft/the-search-for-answers.ar.orb';
import orbSl from '../../../../stories/series-5-craft/the-search-for-answers.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/The Search for Answers',
