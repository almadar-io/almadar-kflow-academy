...
import orbEn from '../../../../stories/series-5-craft/the-editor-as-instrument.orb';
import orbAr from '../../../../stories/series-5-craft/the-editor-as-instrument.ar.orb';
import orbSl from '../../../../stories/series-5-craft/the-editor-as-instrument.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/The Editor as Instrument',
