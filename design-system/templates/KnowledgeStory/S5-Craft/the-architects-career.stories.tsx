...
import orbEn from '../../../../stories/series-5-craft/the-architects-career.orb';
import orbAr from '../../../../stories/series-5-craft/the-architects-career.ar.orb';
import orbSl from '../../../../stories/series-5-craft/the-architects-career.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/The Architects Career',
