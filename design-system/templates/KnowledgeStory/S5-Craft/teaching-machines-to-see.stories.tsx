...
import orbEn from '../../../../stories/series-5-craft/teaching-machines-to-see.orb';
import orbAr from '../../../../stories/series-5-craft/teaching-machines-to-see.ar.orb';
import orbSl from '../../../../stories/series-5-craft/teaching-machines-to-see.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/Teaching Machines to See',
