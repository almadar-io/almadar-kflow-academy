...
import orbEn from '../../../../../stories/series-1-code/S1-foundations/ten-days-to-change-the-web.orb';
import orbAr from '../../../../../stories/series-1-code/S1-foundations/ten-days-to-change-the-web.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S1-foundations/ten-days-to-change-the-web.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S1 Code/S1 Foundations/Ten Days to Change the Web',
