...
import orbEn from '../../../../../stories/series-1-code/S1-foundations/lisp-meets-the-browser.orb';
import orbAr from '../../../../../stories/series-1-code/S1-foundations/lisp-meets-the-browser.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S1-foundations/lisp-meets-the-browser.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S1 Code/S1 Foundations/Lisp Meets the Browser',
