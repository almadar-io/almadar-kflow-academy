...
import orbEn from '../../../../../stories/series-1-code/S2-modern-era/facebooks-frankenstein.orb';
import orbAr from '../../../../../stories/series-1-code/S2-modern-era/facebooks-frankenstein.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S2-modern-era/facebooks-frankenstein.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: "KFlow/KnowledgeStory/S1 Code/S2 Modern Era/Facebook's Frankenstein",
