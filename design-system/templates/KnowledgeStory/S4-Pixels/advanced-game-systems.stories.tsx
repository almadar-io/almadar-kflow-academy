...
import orbEn from '../../../../stories/series-4-pixels/advanced-game-systems.orb';
import orbAr from '../../../../stories/series-4-pixels/advanced-game-systems.ar.orb';
import orbSl from '../../../../stories/series-4-pixels/advanced-game-systems.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S4 Pixels/Advanced Game Systems',
