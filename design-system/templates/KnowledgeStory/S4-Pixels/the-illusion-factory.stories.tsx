...
import orbEn from '../../../../stories/series-4-pixels/the-illusion-factory.orb';
import orbAr from '../../../../stories/series-4-pixels/the-illusion-factory.ar.orb';
import orbSl from '../../../../stories/series-4-pixels/the-illusion-factory.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S4 Pixels/The Illusion Factory',
