...
import orbEn from '../../../../stories/series-4-pixels/shaders-painting-with-math.orb';
import orbAr from '../../../../stories/series-4-pixels/shaders-painting-with-math.ar.orb';
import orbSl from '../../../../stories/series-4-pixels/shaders-painting-with-math.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S4 Pixels/Shaders Painting with Math',
