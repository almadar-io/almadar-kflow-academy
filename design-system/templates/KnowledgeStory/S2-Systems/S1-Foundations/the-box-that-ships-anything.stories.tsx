...
import orbEn from '../../../../../stories/series-2-systems/S1-foundations/the-box-that-ships-anything.orb';
import orbAr from '../../../../../stories/series-2-systems/S1-foundations/the-box-that-ships-anything.ar.orb';
import orbSl from '../../../../../stories/series-2-systems/S1-foundations/the-box-that-ships-anything.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S2 Systems/S1 Foundations/The Box That Ships Anything',
