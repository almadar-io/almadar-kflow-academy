...
import orbEn from '../../../../../stories/series-2-systems/S1-foundations/the-packets-journey.orb';
import orbAr from '../../../../../stories/series-2-systems/S1-foundations/the-packets-journey.ar.orb';
import orbSl from '../../../../../stories/series-2-systems/S1-foundations/the-packets-journey.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: "KFlow/KnowledgeStory/S2 Systems/S1 Foundations/The Packet's Journey",
