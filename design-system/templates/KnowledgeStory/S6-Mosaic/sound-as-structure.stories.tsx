...
import orbEn from '../../../../stories/series-6-mosaic/sound-as-structure.orb';
import orbAr from '../../../../stories/series-6-mosaic/sound-as-structure.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/sound-as-structure.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/Sound as Structure',
