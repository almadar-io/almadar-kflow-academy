...
import orbEn from '../../../../stories/series-6-mosaic/the-shape-of-the-world.orb';
import orbAr from '../../../../stories/series-6-mosaic/the-shape-of-the-world.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/the-shape-of-the-world.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/The Shape of the World',
