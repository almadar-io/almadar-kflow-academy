...
import orbEn from '../../../../stories/series-6-mosaic/the-marketplace-of-nations.orb';
import orbAr from '../../../../stories/series-6-mosaic/the-marketplace-of-nations.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/the-marketplace-of-nations.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/The Marketplace of Nations',
