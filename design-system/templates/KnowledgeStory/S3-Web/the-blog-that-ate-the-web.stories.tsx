...
import orbEn from '../../../../stories/series-3-web/the-blog-that-ate-the-web.orb';
import orbAr from '../../../../stories/series-3-web/the-blog-that-ate-the-web.ar.orb';
import orbSl from '../../../../stories/series-3-web/the-blog-that-ate-the-web.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/The Blog That Ate the Web',
