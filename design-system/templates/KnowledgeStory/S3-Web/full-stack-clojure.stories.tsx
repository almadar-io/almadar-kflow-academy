...
import orbEn from '../../../../stories/series-3-web/full-stack-clojure.orb';
import orbAr from '../../../../stories/series-3-web/full-stack-clojure.ar.orb';
import orbSl from '../../../../stories/series-3-web/full-stack-clojure.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/Full-Stack Clojure',
