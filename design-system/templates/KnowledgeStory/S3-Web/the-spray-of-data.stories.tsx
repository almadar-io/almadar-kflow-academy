...
import orbEn from '../../../../stories/series-3-web/the-spray-of-data.orb';
import orbAr from '../../../../stories/series-3-web/the-spray-of-data.ar.orb';
import orbSl from '../../../../stories/series-3-web/the-spray-of-data.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/The Spray of Data',
