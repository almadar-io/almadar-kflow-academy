...
const FirstLayerLoader: React.FC<FirstLayerLoaderProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-gradient-to-br from-indigo-950/80 via-purple-900/70 to-slate-900/80 backdrop-blur">
      <div className="w-full max-w-5xl bg-card text-foreground rounded-2xl shadow-xl border border-indigo-100 max-h-[90vh] flex flex-col mx-4 relative">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 pb-24">
          ...
          {streamContent && (
            <div className="mt-6 border-t border-border pt-6">
              ...
              {extractedGoal && (
                <div className="mb-4 p-4 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 border border-indigo-200 rounded-xl shadow-sm">
                ...
                >
                  {parsedConcepts.map((concept, index) => (
                    <div
                      ...
                      className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-200 rounded-xl p-4 shadow-sm"
                    >
                      <div className="flex items-start gap-3">
