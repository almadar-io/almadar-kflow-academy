          ...
          {completingEmailLink && (
            <form onSubmit={handleCompleteEmailLink} className="space-y-4">
              ...
              <button
                ...
                className="group relative w-full flex justify-center items-center gap-2 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-primary-foreground bg-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 transition-colors duration-fast"
              >
            ...
            <>
              ...
              <div>
                <button
                  ...
                  disabled={loading}
                  className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-primary-foreground bg-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 transition-colors duration-fast"
                >
              ...
              <div>
                ...
                <div className="text-center mt-4">
                  <button
                    ...
                    className="text-primary hover:text-primary-hover transition-colors duration-fast font-medium text-sm"
                  >
