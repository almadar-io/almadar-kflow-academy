    ...
    <>
      ...
      >
        <div className="space-y-4">
          ...
          {selectedText && (
            <div className="bg-surface border-s-4 border-primary p-3 rounded-e-md">
                  ...
                  return (
                    <div key={qa.id} className="border border-border rounded-lg overflow-hidden">
                      <button
                        ...
                        className="w-full px-3 py-2 text-start flex items-center justify-between hover:bg-surface-hover transition-colors"
                      >
                        <Typography variant="body" className="flex-1 truncate font-medium">
                          {qa.question}
                        </Typography>
                        {isExpanded ? (
                          <ChevronUp size={16} className="text-muted-foreground flex-shrink-0 ms-2" />
                        ) : (
                          <ChevronDown size={16} className="text-muted-foreground flex-shrink-0 ms-2" />
                        )}
                      </button>
                      {isExpanded && (
          ...
          {isLoading && !streamingAnswer && (
            <div className="flex items-center justify-center py-8">
              ...
              <Typography variant="body" className="ms-3 text-muted-foreground">
                Generating answer...
              </Typography>
            </div>
          )}
