...
export interface CompanionBellProps {
...
export const CompanionBell: React.FC<CompanionBellProps> = ({
  persona,
  suggestions,
  events,
  loading,
    ...
    <>
                      ...
                      <HStack gap="sm" align="start">
                        ...
                        <VStack gap="xs" className="min-w-0 flex-1">
                          ...
                          <HStack gap="xs" className="mt-1">
                            <Button size="sm" variant="primary" onClick={() => onAccept(s)}>
                              {t('companion.accept')}
                            </Button>
      ...
      {showChat && (
        <CompanionChat
          ...
          replying={replying}
          onReply={onReply}
          onAcceptSuggestion={(s) => { onAccept(s); handleCloseChat(); }}
