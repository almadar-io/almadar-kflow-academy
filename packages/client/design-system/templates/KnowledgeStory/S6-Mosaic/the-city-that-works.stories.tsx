...
import orbEn from '../../../../stories/series-6-mosaic/the-city-that-works.orb';
import orbAr from '../../../../stories/series-6-mosaic/the-city-that-works.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/the-city-that-works.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/The City That Works',
