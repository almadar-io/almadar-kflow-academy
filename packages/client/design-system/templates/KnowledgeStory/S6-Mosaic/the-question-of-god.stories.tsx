...
import orbEn from '../../../../stories/series-6-mosaic/the-question-of-god.orb';
import orbAr from '../../../../stories/series-6-mosaic/the-question-of-god.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/the-question-of-god.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/The Question of God',
