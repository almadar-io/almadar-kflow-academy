...
import orbEn from '../../../../stories/series-6-mosaic/sculpting-in-three-dimensions.orb';
import orbAr from '../../../../stories/series-6-mosaic/sculpting-in-three-dimensions.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/sculpting-in-three-dimensions.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/Sculpting in Three Dimensions',
