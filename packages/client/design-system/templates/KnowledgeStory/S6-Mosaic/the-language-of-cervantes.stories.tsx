...
import orbEn from '../../../../stories/series-6-mosaic/the-language-of-cervantes.orb';
import orbAr from '../../../../stories/series-6-mosaic/the-language-of-cervantes.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/the-language-of-cervantes.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/The Language of Cervantes',
