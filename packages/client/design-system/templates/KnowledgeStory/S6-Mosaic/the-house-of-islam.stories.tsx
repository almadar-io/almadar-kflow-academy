...
import orbEn from '../../../../stories/series-6-mosaic/the-house-of-islam.orb';
import orbAr from '../../../../stories/series-6-mosaic/the-house-of-islam.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/the-house-of-islam.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/The House of Islam',
