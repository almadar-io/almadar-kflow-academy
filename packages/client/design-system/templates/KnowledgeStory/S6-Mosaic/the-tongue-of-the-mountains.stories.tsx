...
import orbEn from '../../../../stories/series-6-mosaic/the-tongue-of-the-mountains.orb';
import orbAr from '../../../../stories/series-6-mosaic/the-tongue-of-the-mountains.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/the-tongue-of-the-mountains.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/The Tongue of the Mountains',
