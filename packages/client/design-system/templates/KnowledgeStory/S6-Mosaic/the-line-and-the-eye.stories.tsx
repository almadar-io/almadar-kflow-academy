...
import orbEn from '../../../../stories/series-6-mosaic/the-line-and-the-eye.orb';
import orbAr from '../../../../stories/series-6-mosaic/the-line-and-the-eye.ar.orb';
import orbSl from '../../../../stories/series-6-mosaic/the-line-and-the-eye.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S6 Mosaic/The Line and the Eye',
