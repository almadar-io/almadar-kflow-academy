...
import orbEn from '../../../../stories/series-4-pixels/physics-you-can-play-with.orb';
import orbAr from '../../../../stories/series-4-pixels/physics-you-can-play-with.ar.orb';
import orbSl from '../../../../stories/series-4-pixels/physics-you-can-play-with.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S4 Pixels/Physics You Can Play With',
