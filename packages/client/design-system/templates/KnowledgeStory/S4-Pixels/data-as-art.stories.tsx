...
import orbEn from '../../../../stories/series-4-pixels/data-as-art.orb';
import orbAr from '../../../../stories/series-4-pixels/data-as-art.ar.orb';
import orbSl from '../../../../stories/series-4-pixels/data-as-art.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S4 Pixels/Data as Art',
