...
import orbEn from '../../../../stories/series-4-pixels/the-game-loop.orb';
import orbAr from '../../../../stories/series-4-pixels/the-game-loop.ar.orb';
import orbSl from '../../../../stories/series-4-pixels/the-game-loop.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S4 Pixels/The Game Loop',
