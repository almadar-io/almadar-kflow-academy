...
import orbEn from '../../../../stories/series-4-pixels/worlds-in-the-browser.orb';
import orbAr from '../../../../stories/series-4-pixels/worlds-in-the-browser.ar.orb';
import orbSl from '../../../../stories/series-4-pixels/worlds-in-the-browser.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S4 Pixels/Worlds in the Browser',
