...
import orbEn from '../../../../stories/series-5-craft/the-pattern-language.orb';
import orbAr from '../../../../stories/series-5-craft/the-pattern-language.ar.orb';
import orbSl from '../../../../stories/series-5-craft/the-pattern-language.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/The Pattern Language',
