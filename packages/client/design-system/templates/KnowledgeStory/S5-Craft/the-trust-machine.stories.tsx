...
import orbEn from '../../../../stories/series-5-craft/the-trust-machine.orb';
import orbAr from '../../../../stories/series-5-craft/the-trust-machine.ar.orb';
import orbSl from '../../../../stories/series-5-craft/the-trust-machine.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/The Trust Machine',
