...
import orbEn from '../../../../stories/series-5-craft/the-quality-gate.orb';
import orbAr from '../../../../stories/series-5-craft/the-quality-gate.ar.orb';
import orbSl from '../../../../stories/series-5-craft/the-quality-gate.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/The Quality Gate',
