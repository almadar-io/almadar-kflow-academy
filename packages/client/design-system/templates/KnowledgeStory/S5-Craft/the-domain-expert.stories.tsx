...
import orbEn from '../../../../stories/series-5-craft/the-domain-expert.orb';
import orbAr from '../../../../stories/series-5-craft/the-domain-expert.ar.orb';
import orbSl from '../../../../stories/series-5-craft/the-domain-expert.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S5 Craft/The Domain Expert',
