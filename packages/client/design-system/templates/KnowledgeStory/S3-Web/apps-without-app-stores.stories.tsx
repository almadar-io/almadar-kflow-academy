...
import orbEn from '../../../../stories/series-3-web/apps-without-app-stores.orb';
import orbAr from '../../../../stories/series-3-web/apps-without-app-stores.ar.orb';
import orbSl from '../../../../stories/series-3-web/apps-without-app-stores.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/Apps Without App Stores',
