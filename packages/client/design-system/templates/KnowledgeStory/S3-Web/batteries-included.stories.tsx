...
import orbEn from '../../../../stories/series-3-web/batteries-included.orb';
import orbAr from '../../../../stories/series-3-web/batteries-included.ar.orb';
import orbSl from '../../../../stories/series-3-web/batteries-included.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/Batteries Included',
