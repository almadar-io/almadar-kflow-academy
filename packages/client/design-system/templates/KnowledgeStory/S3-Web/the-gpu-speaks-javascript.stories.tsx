...
import orbEn from '../../../../stories/series-3-web/the-gpu-speaks-javascript.orb';
import orbAr from '../../../../stories/series-3-web/the-gpu-speaks-javascript.ar.orb';
import orbSl from '../../../../stories/series-3-web/the-gpu-speaks-javascript.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/The GPU Speaks JavaScript',
