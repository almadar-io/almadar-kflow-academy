...
import orbEn from '../../../../stories/series-3-web/data-made-visible.orb';
import orbAr from '../../../../stories/series-3-web/data-made-visible.ar.orb';
import orbSl from '../../../../stories/series-3-web/data-made-visible.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/Data Made Visible',
