...
import orbEn from '../../../../stories/series-3-web/the-middleware-stack.orb';
import orbAr from '../../../../stories/series-3-web/the-middleware-stack.ar.orb';
import orbSl from '../../../../stories/series-3-web/the-middleware-stack.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/The Middleware Stack',
