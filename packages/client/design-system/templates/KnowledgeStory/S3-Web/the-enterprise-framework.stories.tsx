...
import orbEn from '../../../../stories/series-3-web/the-enterprise-framework.orb';
import orbAr from '../../../../stories/series-3-web/the-enterprise-framework.ar.orb';
import orbSl from '../../../../stories/series-3-web/the-enterprise-framework.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/The Enterprise Framework',
