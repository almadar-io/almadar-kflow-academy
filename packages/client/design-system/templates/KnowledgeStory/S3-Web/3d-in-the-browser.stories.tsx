...
import orbEn from '../../../../stories/series-3-web/3d-in-the-browser.orb';
import orbAr from '../../../../stories/series-3-web/3d-in-the-browser.ar.orb';
import orbSl from '../../../../stories/series-3-web/3d-in-the-browser.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/3D in the Browser',
