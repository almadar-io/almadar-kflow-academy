...
import orbEn from '../../../../stories/series-3-web/the-server-side-renaissance.orb';
import orbAr from '../../../../stories/series-3-web/the-server-side-renaissance.ar.orb';
import orbSl from '../../../../stories/series-3-web/the-server-side-renaissance.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S3 Web/The Server-Side Renaissance',
