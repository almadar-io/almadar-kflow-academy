...
import orbEn from '../../../../../stories/series-1-code/S1-foundations/the-logicians-dream.orb';
import orbAr from '../../../../../stories/series-1-code/S1-foundations/the-logicians-dream.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S1-foundations/the-logicians-dream.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: "KFlow/KnowledgeStory/S1 Code/S1 Foundations/The Logician's Dream",
