...
import orbEn from '../../../../../stories/series-1-code/S1-foundations/write-once-run-anywhere.orb';
import orbAr from '../../../../../stories/series-1-code/S1-foundations/write-once-run-anywhere.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S1-foundations/write-once-run-anywhere.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S1 Code/S1 Foundations/Write Once Run Anywhere',
