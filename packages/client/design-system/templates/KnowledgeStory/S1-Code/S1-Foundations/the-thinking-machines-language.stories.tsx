...
import orbEn from '../../../../../stories/series-1-code/S1-foundations/the-thinking-machines-language.orb';
import orbAr from '../../../../../stories/series-1-code/S1-foundations/the-thinking-machines-language.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S1-foundations/the-thinking-machines-language.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: "KFlow/KnowledgeStory/S1 Code/S1 Foundations/The Thinking Machine's Language",
