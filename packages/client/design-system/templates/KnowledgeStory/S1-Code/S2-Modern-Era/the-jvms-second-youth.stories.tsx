...
import orbEn from '../../../../../stories/series-1-code/S2-modern-era/the-jvms-second-youth.orb';
import orbAr from '../../../../../stories/series-1-code/S2-modern-era/the-jvms-second-youth.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S2-modern-era/the-jvms-second-youth.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: "KFlow/KnowledgeStory/S1 Code/S2 Modern Era/The JVM's Second Youth",
