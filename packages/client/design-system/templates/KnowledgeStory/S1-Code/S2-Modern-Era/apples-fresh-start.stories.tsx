...
import orbEn from '../../../../../stories/series-1-code/S2-modern-era/apples-fresh-start.orb';
import orbAr from '../../../../../stories/series-1-code/S2-modern-era/apples-fresh-start.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S2-modern-era/apples-fresh-start.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: "KFlow/KnowledgeStory/S1 Code/S2 Modern Era/Apple's Fresh Start",
