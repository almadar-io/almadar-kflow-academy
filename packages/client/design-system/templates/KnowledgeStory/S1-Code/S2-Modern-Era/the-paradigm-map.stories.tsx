...
import orbEn from '../../../../../stories/series-1-code/S2-modern-era/the-paradigm-map.orb';
import orbAr from '../../../../../stories/series-1-code/S2-modern-era/the-paradigm-map.ar.orb';
import orbSl from '../../../../../stories/series-1-code/S2-modern-era/the-paradigm-map.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S1 Code/S2 Modern Era/The Paradigm Map',
