...
import orbEn from '../../../../../stories/series-2-systems/S1-foundations/the-table-that-remembers.orb';
import orbAr from '../../../../../stories/series-2-systems/S1-foundations/the-table-that-remembers.ar.orb';
import orbSl from '../../../../../stories/series-2-systems/S1-foundations/the-table-that-remembers.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S2 Systems/S1 Foundations/The Table That Remembers',
