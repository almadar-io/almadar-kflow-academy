...
import orbEn from '../../../../../stories/series-2-systems/S1-foundations/what-is-a-computer-really.orb';
import orbAr from '../../../../../stories/series-2-systems/S1-foundations/what-is-a-computer-really.ar.orb';
import orbSl from '../../../../../stories/series-2-systems/S1-foundations/what-is-a-computer-really.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S2 Systems/S1 Foundations/What Is a Computer Really',
