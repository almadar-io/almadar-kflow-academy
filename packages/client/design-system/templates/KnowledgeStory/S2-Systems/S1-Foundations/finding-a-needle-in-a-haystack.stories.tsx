...
import orbEn from '../../../../../stories/series-2-systems/S1-foundations/finding-a-needle-in-a-haystack.orb';
import orbAr from '../../../../../stories/series-2-systems/S1-foundations/finding-a-needle-in-a-haystack.ar.orb';
import orbSl from '../../../../../stories/series-2-systems/S1-foundations/finding-a-needle-in-a-haystack.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S2 Systems/S1 Foundations/Finding a Needle in a Haystack',
