...
import orbEn from '../../../../../stories/series-2-systems/S2-distributed/the-message-broker.orb';
import orbAr from '../../../../../stories/series-2-systems/S2-distributed/the-message-broker.ar.orb';
import orbSl from '../../../../../stories/series-2-systems/S2-distributed/the-message-broker.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S2 Systems/S2 Distributed/The Message Broker',
