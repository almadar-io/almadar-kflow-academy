...
import orbEn from '../../../../../stories/series-2-systems/S2-distributed/the-consensus-problem.orb';
import orbAr from '../../../../../stories/series-2-systems/S2-distributed/the-consensus-problem.ar.orb';
import orbSl from '../../../../../stories/series-2-systems/S2-distributed/the-consensus-problem.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S2 Systems/S2 Distributed/The Consensus Problem',
