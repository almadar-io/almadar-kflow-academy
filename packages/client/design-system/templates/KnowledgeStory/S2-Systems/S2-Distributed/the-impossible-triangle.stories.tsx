...
import orbEn from '../../../../../stories/series-2-systems/S2-distributed/the-impossible-triangle.orb';
import orbAr from '../../../../../stories/series-2-systems/S2-distributed/the-impossible-triangle.ar.orb';
import orbSl from '../../../../../stories/series-2-systems/S2-distributed/the-impossible-triangle.sl.orb';

const orbs: LocaleOrbMap = { en: orbEn, ar: orbAr, sl: orbSl };

const meta: Meta<typeof KnowledgeStoryTemplate> = {
  title: 'KFlow/KnowledgeStory/S2 Systems/S2 Distributed/The Impossible Triangle',
