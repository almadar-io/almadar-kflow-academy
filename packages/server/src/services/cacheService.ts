...
export const CACHE_TTL = {
  STATISTICS: THREE_HOURS_MS,
  USER_PREFERENCES: THREE_HOURS_MS,
  RECOMMENDATIONS: THREE_HOURS_MS,
  ACHIEVEMENTS: THREE_HOURS_MS,
  GRAPH_QUERY: THREE_HOURS_MS,
  JUMP_BACK_IN: THREE_HOURS_MS,
  ENROLLMENTS: THREE_HOURS_MS,
  USER_PROGRESS: THREE_HOURS_MS,
  LEARNING_PATHS: THREE_HOURS_MS,
  GRAPH: THREE_HOURS_MS,
  GRAPHOLOGY: THREE_HOURS_MS,
};
